...
public class OrderServicePayloadRootAnnotationEndPoint {
    ...
    @PayloadRoot(localPart = "placeOrderRequest", namespace = "http://www.smartrevolutionaryit.fr/OrderService/schema")
    public JAXBElement<PlaceOrderResponse> getOrder(
        ...
        return new JAXBElement<PlaceOrderResponse>(new QName(
                "http://www.smartrevolutionaryit.fr/OrderService/schema",
                "placeOrderResponse"), PlaceOrderResponse.class, response);
    }

    @PayloadRoot(localPart = "cancelOrderRequest", namespace = "http://www.smartrevolutionaryit.fr/OrderService/schema")
